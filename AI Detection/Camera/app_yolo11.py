...
# โฟลเดอร์ที่ไฟล์นี้อยู่ — ใช้อ้างอิงไฟล์ weights/CSV ให้ทำงานได้ไม่ว่าจะรันจาก cwd ไหน
...
# CONFIG
# =========================================================
RTSP_URL = "rtsp://192.168.0.138:8554/unicast"
...
# ===== AI config =====
AI_MODEL_PATH = os.path.join(_HERE, "X7.pt")
AI_CONF   = 0.35
AI_IOU    = 0.45
AI_IMGSZ  = 640
AI_TASK   = "detect"
...
# ===== AI CSV config =====
AI_CSV_FILE  = "ai_detection_log.csv"
AI_LOG_MAX   = 500
...
if __name__ == "__main__":
    import os
    log("Starting RTSP-from-Pi Motion / QR / YOLO11 AI server...")
